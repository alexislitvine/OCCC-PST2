...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--data-path', type=str, default="data/labelled_data")
    parser.add_argument('--file', type=str, default="data/labelled_data/EN_PSTI_CAMPOP_n_unq100000_train.csv")  # Path to file with data to be translated. If None, the script will use the data_path and load all files in it.
    ...
    parser.add_argument('--num-adv-simple', type=int, default=10000)
    parser.add_argument('--num-adv-double-trans', type=int, default=10000)
    parser.add_argument('--num-trans', type=int, default=20000)
    parser.add_argument('--num-rand', type=int, default=2000)
    ...
    parser.add_argument('--no-occ-labels', type=str, nargs="*", default=["6,0,0,0,0,0,0,0"])

    parser.add_argument('--model-path', default="models/mixer-psti-ft/last.bin")
